...
%x yy_string    //state variable to handle strings
%x yy_escape    //state variable to handle escape sequence
%x yy_comment   //state variable to hanle nesting of comments
